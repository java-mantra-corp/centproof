...
export const metadata: Metadata = {
  ...
  title: {
    ...
    // home/fallback title.
    default:
      "CentProof | Private finance software that stays on your Mac.",
...
function StructuredData() {
  const data = {
    ...
    offers: [
      {
        // Stay in sync with /pricing's pricingPlans config and the
        // LemonSqueezy product price.  $49 is the post-launch
        // Lifetime price; the $29 launch coupon is a time-limited
        // discount, not the structured-data canonical price.
        "@type": "Offer",
