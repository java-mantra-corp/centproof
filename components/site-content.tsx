...
export const productSections = [
  {
    title: "Statement Import & Parsing",
    imageTitle: "Statement import screenshot",
    imagePath: "/images/product/statements.png",
  ...
  {
    title: "Ask CentProof",
    imageTitle: "Ask CentProof screenshot",
  ...
  {
    title: "Local Backup",
    imageTitle: "Pricing / license screen screenshot",
